...
// Electron/WebDriver検出を無効化（Googleログイン対策）
    ...
    view.webContents.executeJavaScript(`
      (function() {
        ...
        try {
          ...
          Object.defineProperty(navigator, 'plugins', { get: () => { const arr = [1,2,3]; arr.item = i => arr[i]; arr.namedItem = () => null; arr.refresh = () => {}; return arr; }, configurable: true });
        } catch(e) {}
      })();
    `).catch(() => {});
  });
